...
This will copy the URL to your clipboard, e.g. `https://stg-app.ShieldSign.com/d/-WoSwWVT-fYOERS2MI37k`
...
So `https://stg-app.ShieldSign.com/sign/lm7Tp2_yhvFfzdeJQzYQF` will become `lm7Tp2_yhvFfzdeJQzYQF`
