...
description: Learn how to set up OAuth providers for your own instance of ShieldSign.
---
...
9. Set the authorized javascript origins to `https://<ShieldSign-domain>`
10. Set the authorized redirect URIs to `https://<ShieldSign-domain>/api/auth/callback/google`
11. In the ShieldSign environment variables, set the following:
...
5. Enter a name for your application (e.g., "ShieldSign")
...
7. Under **Redirect URI**, select **Web** and enter: `https://<ShieldSign-domain>/api/auth/callback/microsoft`
8. Click **Register**
...
7. In the ShieldSign environment variables, set the following:
