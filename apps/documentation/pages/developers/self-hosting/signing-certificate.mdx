...
description: Learn how to generate or buy a signing certificate for your ShieldSign instance.
---
...
Self-hosting your ShieldSign instance requires your own certificate to sign documents.
...
The main drawback is that mainstream PDF readers like Adobe won't recognize the signature as a trusted source or show a green checkmark. The certificate will still include your company/personal data to prove your ShieldSign instance signed the document. It also guarantees that the document wasn't altered after signing.

You can generate your signing certificate by following [this guide](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/developers/local-development/signing-certificate.mdx).
...
Receiving your signing certificate is similar to receiving an SSL certificate. Since you need the actual certificate as part of the ShieldSign config, you must generate a secret private key and a CSR (Certificate Signing Request).
...
### Configure ShieldSign to use the certificate
