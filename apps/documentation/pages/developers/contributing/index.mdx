...
Search the existing [issues](https://github.com/ShieldSign/ShieldSign/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/ShieldSign/ShieldSign/pulls) to see if someone else is already working on the same thing.
