...
description: Learn how to contribute to ShieldSign and become part of our community.
---
...
This guide will help you get started with contributing to ShieldSign.
...
Search the existing [issues](https://github.com/KatalystDigital/shieldsign-core/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/KatalystDigital/shieldsign-core/pulls) to see if someone else is already working on the same thing.
...
### Set Up ShieldSign Locally

To set up your local environment, check out the [local development](https://github.com/KatalystDigital/shieldsign-core/tree/main/apps/documentation/pages/developers/local-development) guide.
...
> **Note:** If you need help getting started, [create an issue on GitHub](https://github.com/KatalystDigital/shieldsign-core/issues).
