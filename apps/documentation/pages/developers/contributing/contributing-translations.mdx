...
description: Learn how to contribute translations to ShieldSign and become part of our community.
---
...
For development notes on translations, see [`apps/documentation/pages/developers/local-development/translations.mdx`](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/developers/local-development/translations.mdx).
...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/KatalystDigital/shieldsign-core/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out ShieldSign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie ShieldSign.</0>"
```
...
<Callout type="info">
  If you have any questions, open an issue on our [GitHub repository](https://github.com/KatalystDigital/shieldsign-core/issues).
</Callout>

Thank you for helping make ShieldSign more accessible to users around the world!
