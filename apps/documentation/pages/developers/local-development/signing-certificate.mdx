...
Details about environment variables associated with certificates can be found [here](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/developers/self-hosting/signing-certificate.mdx).
