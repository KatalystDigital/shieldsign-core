...
description: Versioning information for the ShieldSign public API.
---
...
ShieldSign uses API versioning to manage changes to the public API. This allows us to introduce new features, fix bugs, and make other changes without breaking existing integrations.

> **Note:** The current version of the API is `v2`.

The API version is specified in the URL. For example, the base URL for the `v2` API is `https://your-domain.com/api/v2`.
