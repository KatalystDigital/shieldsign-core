...
- [TypeScript](https://github.com/ShieldSign/sdk-typescript)
- [Python](https://github.com/ShieldSign/sdk-python)
- [Go](https://github.com/ShieldSign/sdk-go)

<Callout type="info">
  For the staging API, please use the following base URL: `https://stg-app.ShieldSign.com/api/v2/`
</Callout>

## API V1 - Deprecated

Check out the [API V1 documentation](https://app.ShieldSign.com/api/v1/openapi) for details about the API endpoints, request parameters, response formats, and authentication methods.
