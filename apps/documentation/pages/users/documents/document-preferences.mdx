...
- **Document Visibility** - Set the default visibility of the documents created by team members. Learn more about [document visibility](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/document-visibility.mdx).
...
- **Sender Details** - Set whether the sender's name should be included in the emails sent by the team. See more below in the Sender Details section.
