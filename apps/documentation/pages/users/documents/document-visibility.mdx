...
This value can either be set in the [document preferences](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/document-preferences.mdx), or when you create the document.
...
The default document visibility is set to "_EVERYONE_" by default. You can change this setting by going to the [document preferences page](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/document-preferences.mdx) and selecting a different visibility option.
...
> **Note:** Updating the default document visibility in the team's general preferences will not affect the visibility of existing documents. You will need to update the visibility of each document individually.
