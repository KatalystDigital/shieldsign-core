...
The guide assumes you have a ShieldSign account. If you don't, you can create a free account at your ShieldSign instance.

### Upload Document

Navigate to the ShieldSign dashboard at `https://your-domain.com/documents` and click on the "Upload Document" button located at the top right of the page. Select the documents you want to upload and wait for the upload to complete.

> **Note:** The maximum file size for uploaded documents is 150MB in production. You can upload up to 5 documents at a time on standard plans. In staging, the limit is 50MB.
...
> **Note:** Learn more about the available field types and how to use them on the [Fields page](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/fields.mdx).
...
```bash
https://your-domain.com/sign/12ACP777zxQLO52hjj_vCB
```
...
> **Note:** The "Recipient Authentication" feature is only available for Enterprise accounts.
