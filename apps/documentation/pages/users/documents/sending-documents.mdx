...
The guide assumes you have a ShieldSign account. If you don't, you can create a free account [here](https://documen.so/free-docs).

### Upload Document

Navigate to the [ShieldSign dashboard](https://app.ShieldSign.com/documents) and click on the "Upload Document" button located at the top right of the page. Select the documents you want to upload and wait for the upload to complete.
...
![ShieldSign dashboard](/document-signing/shieldsign-documents-dashboard.webp)
...
The ShieldSign editor allows you to create and configure documents or templates. The editor consists of three sections that guide you through the process of preparing your document.
...
![Editor page in the ShieldSign dashboard](/document-signing/editor-overview.webp)
...
![Upload and add recipients page in the ShieldSign editor](/document-signing/editor-upload-recipients.webp)
...
ShieldSign has 5 roles for recipients with different permissions and actions.
...
ShieldSign supports 10 different field types that can be added to the document. Each field type collects various information from the recipients when they sign the document.
...
![The available field types in the ShieldSign dashboard](/document-signing/shieldsign-document-fields.webp)
...
![Preview section in the ShieldSign editor](/document-signing/shieldsign-editor-preview.webp)

### Email Settings

Before sending the document, you can configure the email settings and customize the subject line, message, and sender name.

![Email settings in the ShieldSign dashboard](/document-signing/shieldsign-document-email-settings.webp)

If you leave the email subject and message empty, ShieldSign will use the default email template.
...
![The email sent to the recipients with the signing link](/document-signing/shieldsign-sign-email.webp)
...
![How to copy the signing link for each recipient from the ShieldSign dashboard](/document-signing/shieldsign-signing-links.webp)

The signing link has the following format:

```bash
https://app.ShieldSign.com/sign/12ACP777zxQLO52hjj_vCB
```
...
![General ShieldSign editor settings](/document-signing/shieldsign-editor-general-settings.webp)
...
![Email ShieldSign editor settings](/document-signing/shieldsign-editor-email-settings.webp)
...
ShieldSign enables you to set up access control for your documents. You can require authentication for viewing the document.
...
![Security ShieldSign editor settings](/document-signing/shieldsign-editor-security-settings.webp)
