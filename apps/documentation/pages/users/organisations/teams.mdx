---
title: Teams
description: Learn how to create and manage teams in ShieldSign.
---
...
ShieldSign teams allow you to collaborate with others on creating, sending and receiving documents within your organisation. Teams operate within the organisational structure and inherit settings and branding from their parent organisation.
...
```bash
https://your-domain.com/t/<team-url>
```
...
See the [organisation members](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/members.mdx#invite-organisation-members) page for more information.
...
See the [organisation groups](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/groups.mdx) page for more information.
...
- [Branding preferences](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/branding.mdx)

## What's next?

- [Send your first document](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/sending-documents.mdx)
- [Setup your default document preferences](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/document-preferences.mdx)
- [Setup your default branding preferences](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/branding.mdx)
