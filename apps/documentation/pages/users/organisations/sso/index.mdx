...
- **Single Sign-On**: Access ShieldSign using your own authentication system
...
> **Warning:** Anyone who signs in through your portal will be added to your organisation as a member.
...
See the [Microsoft Entra ID](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/sso/microsoft-entra-id.mdx) guide to find the values for the following fields.
...
Create a custom subdomain for your organisation's SSO portal. For example, you can create a subdomain like `ShieldSign.your-organisation.com` which redirects to the portal link.
...
- Ensure the redirect URI in ShieldSign matches exactly what's configured in your identity provider
...
2. Check the ShieldSign logs for detailed error messages
...
- [Microsoft Entra ID](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/sso/microsoft-entra-id.mdx) - Complete guide for Azure AD configuration
