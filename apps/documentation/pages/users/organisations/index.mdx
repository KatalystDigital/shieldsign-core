---
title: Organisations
description: Learn how to create and manage organisations in ShieldSign.
---
...
Organisations are the top-level entity in ShieldSign's hierarchy structure.
...
- [Create Your First Team](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/teams.mdx)
- [Invite Organisation Members](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/members.mdx)
- [Create Organisation Groups](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/groups.mdx)
- [Manage Default Settings](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/document-preferences.mdx)
- [Manage Default Branding](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/branding.mdx)
