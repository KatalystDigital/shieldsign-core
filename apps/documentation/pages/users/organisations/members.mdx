...
> **Note:** Organisation admins and managers will automatically have access to all teams as the "Team Admin" role. When creating a team you can also decide whether to automatically allow normal members to access it by default as well.
...
| Email address         | Role    |
| --------------------- | ------- |
| org-admin@example.com   | Admin   |
| org-manager@example.com | Manager |
| org-member@example.com  | Member  |

> **Note:** The basic team plan includes 5 organisation members. Going over the 5 members will charge your organisation according to the seat plan pricing.
...
- [Use groups to organise your members](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/organisations/groups.mdx)
