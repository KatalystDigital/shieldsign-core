...
The ShieldSign Enterprise Edition is our license for self-hosters that need the full range of support and compliance. Everything in the EE folder and all features listed [here](https://github.com/ShieldSign/ShieldSign/blob/main/packages/ee/FEATURES) can be used after acquiring a paid license.
