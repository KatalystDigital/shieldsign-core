...
ShieldSign allows you to create templates, which are reusable documents. Templates are helpful if you often send the same type of document, such as contracts, agreements, or invoices, as they help you save time.
...
See the [documents](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/documents/sending-documents.mdx) page for more information on how to use the editor.
...
> **Note:** Check out the [Direct Signing Links](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/direct-links.mdx) section for more information.
