...
![Template page in the ShieldSign dashboard](/direct-links/document-direct-link-ShieldSign.webp)
...
![Enable the document direct link in the ShieldSign dashboard](/direct-links/enable-document-direct-link-modal.webp)
...
![Choose the Direct Link recipient](/direct-links/choose-direct-link-recipient-ShieldSign.webp)
...
```bash
https://app.ShieldSign.com/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [ShieldSign profile](/users/profile) to make them signable anytime.

![Choose the Direct Link recipient](/direct-links/shieldsign-profile.webp)
