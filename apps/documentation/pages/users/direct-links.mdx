...
```bash
https://your-domain.com/d/<random-generated-string>
```

### Optional: Add Templates to Your Profile

You can add templates with direct links to your public [ShieldSign profile](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/profile.mdx) to make them signable anytime.
