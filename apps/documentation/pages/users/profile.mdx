...
description: Learn how to set up your public profile on ShieldSign.
---
...
ShieldSign allows you to create a public profile to share your templates for anyone to sign. This is useful for distributing and collecting signatures for commonly used documents, making it more efficient for both the document creator and the signers.

<Callout type="info">A free ShieldSign account gives you 5 free signatures per month.</Callout>
...
![The profile settings page](/public-profile/shieldsign-public-profile-settings.webp)
...
```bash
https://app.ShieldSign.com/p/<username>
```
...
![An example of a enabling a public profile on ShieldSign](/public-profile/shieldsign-enable-public-profile-settings.webp)
...
![An example of a public profile on ShieldSign](/direct-links/shieldsign-profile.webp)

The image above shows an example of a public profile on ShieldSign.
...
<Callout>Tag @ShieldSign on X to get a retweet and an endorsement from us.</Callout>
