...
> **Note:** A free ShieldSign account gives you 5 free signatures per month.
...
Learn more about [templates](https://github.com/KatalystDigital/shieldsign-core/blob/main/apps/documentation/pages/users/templates.mdx).
