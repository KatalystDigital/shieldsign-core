...
import { downloadFile } from '@shieldsign/lib/client-only/download-file';
import { useCurrentOrganisation } from '@shieldsign/lib/client-only/providers/organisation';
import { IS_BILLING_ENABLED, SUPPORT_EMAIL } from '@shieldsign/lib/constants/app';
...
import { ZCreateOrganisationMemberInvitesRequestSchema } from '@shieldsign/trpc/server/organisation-router/create-organisation-member-invites.types';
...
export const OrganisationMemberInviteDialog = ({
  ...
  const downloadTemplate = () => {
    ...
    downloadFile({
      filename: 'shieldsign-organisation-member-invites-template.csv',
      data: blob,
    });
  };
