...
import { DEFAULT_SIGNATURE_TEXT_FONT_SIZE } from '@shieldsign/lib/constants/pdf';
import { type TSignatureFieldMeta, ZSignatureFieldMeta } from '@shieldsign/lib/types/field-meta';
