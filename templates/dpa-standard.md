...
**Data Controller:**
- Company Name: {{CONTROLLER_COMPANY}}
...
- Controller's customers and partners
...
3.5 Delete or return all Personal Data upon termination of the Agreement.
...
Signature: [[SIGNATURE:controller]]

Name: [[NAME:controller_name]]

Title: [[TEXT:controller_title]]

Date: [[DATE:controller_signed]]
...
Name: [[NAME:processor_name]]

Title: [[TEXT:processor_title]]

Date: [[DATE:processor_signed]]
