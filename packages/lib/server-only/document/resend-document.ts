...
import { DocumentInviteEmailTemplate } from '@shieldsign/email/templates/document-invite';
import {
...
import { renderCustomEmailTemplate } from '@shieldsign/lib/utils/render-custom-email-template';
