...
import DocumentRejectedEmail from '@shieldsign/email/templates/document-rejected';
import DocumentRejectionConfirmedEmail from '@shieldsign/email/templates/document-rejection-confirmed';
import { prisma } from '@shieldsign/prisma';

import { getI18nInstance } from '../../../client-only/providers/i18n-server';
import { NEXT_PUBLIC_WEBAPP_URL } from '../../../constants/app';
import { SHIELDSIGN_INTERNAL_EMAIL } from '../../../constants/email';
...
export const run = async ({
  ...
  await io.runTask('send-owner-notification-email', async () => {
    ...
    await mailer.sendMail({
      ...
      from: SHIELDSIGN_INTERNAL_EMAIL, // Purposefully using internal email here.
