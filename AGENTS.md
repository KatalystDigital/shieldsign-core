# Agent Guidelines for ShieldSign
...
- `npm run test:dev -w @shieldsign/app-tests` - Run single E2E test in dev mode
- `npm run test-ui:dev -w @shieldsign/app-tests` - Run E2E tests with UI
