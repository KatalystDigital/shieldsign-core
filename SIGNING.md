...
```
docker run -d --restart=unless-stopped -p 3000:3000 -v shieldsign:/app/data --name shieldsign shieldsign:latest
```
...
- `shieldsign:latest` - Image you have built
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/shieldsign/shieldsign)
